...
class TaskRiskRequest(BaseModel):
    ...
    SoCongViecPhuThuocTruoc: float = Field(..., ge=0, description="Số task phải hoàn thành trước task này")
    DoUuTien_Encoded: float = Field(..., ge=0, le=3, description="Độ ưu tiên đã mã hóa: 0=Thấp,1=Trung bình,2=Cao,3=Khẩn cấp")
