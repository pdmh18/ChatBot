...
namespace Application.Features.Ai
{
    public class AiIntegrationService : IAiIntegrationService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var dependencyCount = await _repository.CountPreviousDependenciesAsync(
                taskId,
                cancellationToken);
            ...
            var aiResult = await _aiClient.PredictRiskAsync(
                aiRequest,
                cancellationToken);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var userIds = await _repository.GetProjectMemberUserIdsAsync(
                task.MaDuAn,
                cancellationToken);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var aiResults = await _aiClient.AnalyzeBottleneckAsync(
                topN,
                cancellationToken);

            return await _repository.SaveBottleneckResultsAsync(
                aiResults,
                cancellationToken);
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            var aiResult = await _aiClient.MatchStaffAsync(
                aiRequest,
                cancellationToken);
